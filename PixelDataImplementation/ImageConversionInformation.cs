...
namespace PixelDataImplementation
{
    ...
    public sealed class ImageConversionInformation
    {
        ...
        /// </summary>
        [DataMember(Name = "PixelSpacing", EmitDefaultValue = false, Order = 1)]
        ...
        /// </summary>
        [ProposedApi]
        [DataMember(Name = "PixelImagerSpacing", EmitDefaultValue = false, Order = 1)]
        ...
        /// </summary>
        [DataMember(Name = "WindowCenter", EmitDefaultValue = false, Order = 2)]
        ...
        /// </summary>
        [DataMember(Name = "PixelAspectRatio", EmitDefaultValue = false, Order = 3)]
        ...
        /// </summary>
        [DataMember(Name = "RescaleSlope", EmitDefaultValue = false, Order = 5)]
        ...
        /// </summary>
        [DataMember(Name = "RescaleIntercept", EmitDefaultValue = false, Order = 6)]
        ...
        /// </summary>
        [DataMember(Name = "PixelPaddingValue", EmitDefaultValue = false, Order = 7)]
        ...
        /// </summary>
        [DataMember(Name = "PixelPaddingRangeLimitValue", EmitDefaultValue = false, Order = 8)]
        ...
        /// </summary>
        [DataMember(Name = "NumberOfFrames", EmitDefaultValue = false, Order = 9)]
        ...
        /// </summary>
        [DataMember(Name = "SOPClassUID", Order = 10)]
        ...
        /// </summary>
        [DataMember(Name = "PhotometricInterpretation", Order = 11)]
        ...
        /// Gets the PixelPaddingRangeLimitValue of the image
        /// </summary>
        [DataMember(Name = "TransferSyntaxUid", EmitDefaultValue = false, Order = 12)]
        ...
        /// </summary>
        [DataMember(Name = "BitsAllocated", Order = 13)]
        ...
        /// </summary>
        [DataMember(Name = "BitsStored", Order = 14)]
        ...
        /// </summary>
        [DataMember(Name = "HighBit", Order = 15)]
        public int HighBit
        {
        ...
        /// </summary>
        [DataMember(Name = "PixelRepresentation", Order = 16)]
        ...
        /// </summary>
        [DataMember(Name = "Columns", Order = 18)]
        public int Columns
        {
        ...
        /// </summary>
        [DataMember(Name = "SamplesPerPixel", Order = 19)]
        ...
        /// </summary>
        [DataMember(Name = "Offset", Order = 20)]
        public int Offset
        {
            get { return myOffset; }
        ...
        /// </summary>
        [DataMember(Name = "ImageConversionType", Order = 21)]
        ...
        /// </summary>
        [DataMember(Name = "HasPixels", Order = 22)]
        ...
        /// </summary>
        [DataMember(Name = "IsSpectralBaseImage", Order = 23)]
        ...
        private void GetImageInformation(DicomObject dicomObject)
        {
            ...
            {
                // default
                LogHelper.LogInfo("No. of rows not present, defaulting to 512.");
                rows = 512;
            }
            ...
            {
                // default
                LogHelper.LogInfo("No. of columns not present, defaulting to 512.");
                cols = 512;
            }
            Rows = rows.Value;
            Columns = cols.Value;
            ...
            DictionaryTag doubleArrayTag)
        {
            ...
            AIPDicomObject aipObject = record as AIPDicomObject;
            if (aipObject != null)
            {
                Rule rule = aipObject.DicomObjectRule;
                aipObject.DicomObjectRule = noValidationRule;
                result = aipObject.GetDoubleArray(doubleArrayTag);
                aipObject.DicomObjectRule = rule;
            }
            else
            {
        ...
        private static bool IsImageTypeSBI(DicomObject dicomObject)
        {
            if (dicomObject.HasTag(DicomDictionary.DicomImageType))
            {
                ReadOnlyArray<string> imageType =
                    dicomObject.GetStringArray(DicomDictionary.DicomImageType);
                if (
                    imageType != null &&
                    imageType.Length >= 3 &&
                    imageType[2].Equals(
                        MemoryManagerConstants.SBI,
                        StringComparison.OrdinalIgnoreCase
                    ) &&
                    imageType[0].Equals(
                        MemoryManagerConstants.Derived,
                        StringComparison.OrdinalIgnoreCase
                    ) &&
                    imageType[1].Equals(
                        MemoryManagerConstants.Secondary,
                        StringComparison.OrdinalIgnoreCase
                    )
                )
                {
